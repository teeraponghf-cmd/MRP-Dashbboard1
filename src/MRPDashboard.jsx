...
const [hydrating, setHydrating] = useState(true);
  ...
  const exportBOM = () => {
    downloadCSV(`bom_export_${new Date().toISOString().slice(0, 10)}.csv`, bomRowsFiltered);
  };
            ...
            <table style={{ borderCollapse: "collapse", width: "100%", fontFamily: "'IBM Plex Mono', monospace", fontSize: 11.5 }}>
              <thead>
                <tr style={{ position: "sticky", top: 0, background: COLORS.card, zIndex: 1 }}>
                  {["PARENT ITEM", "PARENT DESC", "COMPONENT ITEM", "COMPONENT DESC", "QTY/PARENT", "UNIT", "VENDOR", "LEAD TIME", "LOT SIZE", "MOLD FAMILY"].map((h) => (
              ...
              <tbody>
                ...
                {bomRowsFiltered.length === 0 && (
                  <tr><td colSpan={10} style={{ padding: 20, textAlign: "center", color: COLORS.inkSoft }}>ไม่พบข้อมูล BOM ที่ตรงกับการค้นหา</td></tr>
                )}
              </tbody>
            </table>
          </div>
