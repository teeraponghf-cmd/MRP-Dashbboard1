...
//      GEMINI_MODEL    = gemini-3.6-flash   (หรือ model อื่นที่ต้องการ, ไม่ใส่ก็ได้จะใช้ค่า default นี้)
...
//
// ⚠️ หมายเหตุเรื่อง model: Google เลิกใช้ (deprecate) โมเดลรุ่นเก่าเป็นระยะ (เช่น gemini-2.0-flash
// ถูกปิดไปแล้วมิถุนายน 2026) ถ้าวันไหนเจอ error แบบ "model is no longer available" หรือ 404 NOT_FOUND
// ให้เช็ครุ่นล่าสุดที่ https://ai.google.dev/gemini-api/docs/models แล้วอัปเดตค่า GEMINI_MODEL
// ใน Vercel Environment Variables เป็นชื่อ model ใหม่ (ไม่ต้องแก้โค้ดไฟล์นี้เลย)
